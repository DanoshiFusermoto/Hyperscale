...
public final class Peer extends BasicObject {
  public static final Peer from(final AbstractConnection connection) {
  ...
  public Peer(URI uri, Protocol... protocols) {
    ...
    this.protocols = new LinkedHashSet<Protocol>();
    for (Protocol protocol : protocols) this.protocols.add(protocol);
  }
  ...
  public boolean equals(Object object) {
    ...
    if (object instanceof Peer peer) {
      if (getURI().equals(peer.getURI()) == false) return false;
  ...
  @Override
  public int hashCode() {
    if (this.hashcode == null) this.hashcode = getURI().toString().toLowerCase().hashCode();
