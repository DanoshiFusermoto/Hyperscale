...
public class RadixCBORFactory extends JsonFactory
{
     ...
     * by default.
     */
    static final int DEFAULT_CBOR_GENERATOR_FEATURE_FLAGS = RadixCBORGenerator.Feature.collectDefaults();
    ...
    {
    	return new CBORParserBootstrapper(ctxt, data, offset, len).constructParser(_factoryFeatures, 
    			_parserFeatures, _formatParserFeatures,
                _objectCodec, _byteSymbolCanonicalizer);
    }
    ...
    private final RadixCBORGenerator _createCBORGenerator(IOContext ctxt, int stdFeat, int formatFeat, ObjectCodec codec, OutputStream out) throws IOException
    {
