 ...
 *
 * <p>Note on using non-byte-based sources/targets (char based, like {@link java.io.Reader} and
 * {@link java.io.Writer}): these can not be used for CBOR documents; attempt will throw exception.
 *
...
public class RadixCBORFactory extends JsonFactory {
  ...
  private final RadixCBORGenerator _createCBORGenerator(
