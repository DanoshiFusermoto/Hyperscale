...
public class JacksonCborMapper extends ObjectMapper {
  ...
  public static JacksonCborMapper create(
    ...
    cborModule.addDeserializer(
        Signature.class,
        new StdDeserializer<>(Signature.class) {
          @Override
          public Signature deserialize(JsonParser p, DeserializationContext ctxt)
            ...
            if (bytes == null || bytes.length == 0)
              throw new InvalidFormatException(
                  p, "Expecting signature bytes but null or empty", bytes, handledType());
            ...
            if (bytes[0] == JacksonCodecConstants.EC_SIGNATURE_VALUE)
              ...
              throw new InvalidFormatException(
                  p, "Unexpected prefix " + bytes[0], bytes, handledType());
          }
        });
        ...
        new BeanDeserializerModifier() {
          ...
          public JsonDeserializer<?> modifyDeserializer(
            ...
            if ((deserializer instanceof UntypedObjectDeserializer) == false) {
              ...
              if (Polymorphic.class.isAssignableFrom(beanDesc.getBeanClass())) return deserializer;
