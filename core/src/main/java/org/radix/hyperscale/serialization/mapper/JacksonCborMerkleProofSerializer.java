...
{
	private static final ThreadLocal<ByteBuffer> byteBuffer = ThreadLocal.withInitial(() -> ByteBuffer.allocate(Byte.BYTES + MerkleProof.BYTES));
	...
	@Override
	public void serialize(MerkleProof value, JsonGenerator jgen, SerializerProvider provider) throws IOException 
	{
