...
/**
 * Deserializer for translation from JSON encoded {@code ShardGroupID} data
 * to a {@code ShardGroupID} object.
 */
public class JacksonJsonShardGroupIDDeserializer extends StdDeserializer<ShardGroupID> 
{
	...
	public ShardGroupID deserialize(JsonParser p, DeserializationContext ctxt) throws IOException 
	{
		...
		return ShardGroupID.from(Integer.parseInt(value.substring(JacksonCodecConstants.STR_VALUE_LEN)));
	}
}
