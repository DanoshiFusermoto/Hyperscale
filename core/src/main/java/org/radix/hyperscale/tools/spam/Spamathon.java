...
final public class Spamathon
{
	...
	@SuppressWarnings("unchecked")
	public <T extends Spammer> T spam(final String name, final int iterations, final int rate, final Range<Integer> saturation, final ShardGroupID targetShard, final double shardFactor) throws InstantiationException, NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException
	{
		...
		final Constructor<? extends Spammer> constructor = spammerClass.getDeclaredConstructor(Spamathon.class, int.class, int.class, Range.class, ShardGroupID.class, double.class);
		final Spammer spammer = constructor.newInstance(this, iterations, rate, saturation, targetShard, shardFactor);  
