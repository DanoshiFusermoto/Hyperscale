...
class HashProvider
{
	 ...
	 * The hash is calculated as if the String characters and byte array were concatenated into a single byte array.
	 *
	...
	/**
	 * Hashes the supplied Strings, returning a cryptographically secure 256-bit hash.
	 * The hash is calculated as if the String bytes were contatenated into a single byte array.
	 *
	 * @param data1 The first part of the data to hash
	 * @param data2 The second part of the data to hash
	 * @return The 256-bit/32-byte hash
	...
	/**
	 * Hashes the supplied byte arrays, returning a cryptographically secure 256-bit hash.
	 * The hash is calculated as if the arrays were concatenated into a single byte array.
	 *
	 * @param data1 The first part of the data to hash
	 * @param data2 The second part of the data to hash
	 * @return The 256-bit/32-byte hash
	...
	/**
	 * Hashes the supplied List of byte arrays, returning a cryptographically secure 256-bit hash.
	 * The hash is calculated as if the items in the list were concatenated into a single array.
	 *
	...
	public byte[] hash256(final ArrayList<byte[]> data) 
	{
		...
		for(int i = 0 ; i < data.size() ; i++)
			hash256Digester.update(data.get(i));
	...
	private void processString(final Blake2b hashDigester, final String data, final int offset, final int length)
	{
