...
public class MerkleProof implements Hashable {
  ...
  public static MerkleProof from(String string) {
    ...
    if (string.charAt(0) == 'r') direction = Branch.RIGHT;
    else if (string.charAt(0) == 'l') direction = Branch.LEFT;
  ...
  public boolean equals(Object obj) {
    ...
    if (this.hash.equals(other.hash) == false) return false;
  ...
  public synchronized byte[] toByteArray() {
    if (this.cachedBytes == null)
      this.cachedBytes =
          ArrayUtils.addFirst(this.hash.toByteArray(), (byte) this.direction.ordinal());
