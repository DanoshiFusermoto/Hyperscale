...
final class IndexNodeID {
  ...
  private static final IndexNodeID[][] cache =
      new IndexNodeID[INDEX_NODE_ID_CACHE_SLICES]
          [INDEX_NODE_ID_CACHE_SIZE / INDEX_NODE_ID_CACHE_SLICES];
  ...
  public static final IndexNodeID from(int ID) {
    return compute(ID);
  }
