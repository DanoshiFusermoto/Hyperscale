...
public class TokenArgument implements SubstateArgument<String>
{
	...
	private static final String TOKEN_STATE_CONTEXT = TokenArgument.class.getAnnotation(StateContext.class).value();
	...
	public TokenArgument(final String symbol, final StateLockMode lockMode)
	{
		...
		this.addresses = Collections.singletonList(new AbstractMap.SimpleEntry<>(this.tokenAddress, this.lockMode));
	}
