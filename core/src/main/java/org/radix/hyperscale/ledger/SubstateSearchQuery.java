...
public final class SubstateSearchQuery extends BasicObject {
  ...
  public SubstateSearchQuery(
      final StateAddress address, final Isolation isolation, final boolean localOnly) {
  ...
  public boolean equals(Object object) {
    ...
    if (object instanceof SubstateSearchQuery substateSearchQuery) {
      ...
      if (this.address.equals(substateSearchQuery.getAddress()) == false) return false;

      if (this.isolation.equals(substateSearchQuery.getIsolation()) == false) return false;
