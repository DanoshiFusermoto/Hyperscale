...
public final class SubstateCommit extends BasicObject
{
	...
	SubstateCommit(final Substate substate, final Hash mutator, final long index, final long timestamp)
	{
		Objects.requireNonNull(substate, "Substate is null");
	...
	SubstateCommit(final Substate substate, final Hash mutator, final long index, final long timestamp, final SubstateCommit previous)
	{
		Objects.requireNonNull(substate, "Substate is null");
		Objects.requireNonNull(mutator, "Mutator hash is null");
		Hash.notZero(mutator, "Mutator hash is ZERO");
	...
	{
		return this.substate+" "+(this.mutator == null ? Hash.ZERO : this.mutator)+" "+this.id+" "+this.index+" "+this.timestamp;
	}
}