...
public final class SubstateTransitions extends BasicObject implements StateAddressable
{
	...
	protected <T> T getOrDefault(String field, T def)
	{
		...
		Object value = null;
		if (this.writes != null)
			value = (T) this.writes.get(field);
		if (value == null && this.reads != null)
			value = (T) this.reads.get(field);
		if (value == null)
			value = def;
	...
	public boolean equals(final Object obj) 
	{
		...
		{		
			...
			if (this.reads != null && this.reads.equals(other.reads) == false)
				return false;
		
			if (this.writes != null && this.writes.equals(other.writes) == false)
				return false;
	...
	public Substate toSubstate(final SubstateOutput output)
	{
		...
		if (output.equals(SubstateOutput.READS) == false && output.equals(SubstateOutput.WRITES) == false && output.equals(SubstateOutput.TRANSITIONS) == false)
	...
	{
		return super.toString()+", address="+this.address+", reads="+this.reads+", writes="+this.writes;
	}
}
