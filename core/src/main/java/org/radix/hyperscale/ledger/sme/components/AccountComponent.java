...
public final class AccountComponent extends NativeComponent {
  ...
  public void tokens_accept_add(Identity identity, List<String> tokens) {
    ...
    Set<String> acceptedTokens =
        new LinkedHashSet<String>(get(accountStateAddress, "tokens.accept"));
  ...
  public void tokens_accept_set(Identity identity, List<String> tokens) {
    ...
    Set<String> acceptedTokens;
    if (tokens.isEmpty()) acceptedTokens = Collections.singleton("*");
    else acceptedTokens = new LinkedHashSet<String>(tokens);
  ...
  public void tokens_reject_add(Identity identity, List<String> tokens) {
    ...
    Set<String> rejectedTokens =
        new LinkedHashSet<String>(
            get(accountStateAddress, "tokens.reject", Collections.emptyList()));
  ...
  public void tokens_reject_set(Identity identity, List<String> tokens) {
    ...
    Set<String> rejectedTokens;
    if (tokens.isEmpty()) rejectedTokens = Collections.emptySet();
    else rejectedTokens = new LinkedHashSet<String>(tokens);
  ...
  public void jurisditions_accept_add(Identity identity, List<String> jurisditions) {
    ...
    Set<String> acceptedJurisdictions =
        new LinkedHashSet<String>(
            get(accountStateAddress, "jurisditions.accept", Collections.emptyList()));
  ...
  public void jurisditions_accept_set(Identity identity, List<String> jurisditions) {
    ...
    Set<String> acceptedJurisdictions;
    if (jurisditions.isEmpty()) acceptedJurisdictions = Collections.singleton("*");
    else acceptedJurisdictions = new LinkedHashSet<String>(jurisditions);
  ...
  public void jurisditions_reject_add(Identity identity, List<String> jurisditions) {
    ...
    Set<String> rejectedJurisdictions =
        new LinkedHashSet<String>(
            get(accountStateAddress, "jurisditions.reject", Collections.emptyList()));
  ...
  public void jurisditions_reject_set(Identity identity, List<String> jurisditions) {
    ...
    Set<String> rejectedJurisdictions;
    if (jurisditions.isEmpty()) rejectedJurisdictions = Collections.emptySet();
    else rejectedJurisdictions = new LinkedHashSet<String>(jurisditions);
  ...
  public void identities_accept_add(Identity identity, List<Identity> identities) {
    ...
    Set<Identity> acceptedIdentities =
        new LinkedHashSet<Identity>(
            get(accountStateAddress, "identities.accept", Collections.emptyList()));
  ...
  public void identities_accept_set(Identity identity, List<Identity> identities) {
    ...
    Set<Identity> acceptedIdentities;
    if (identities.isEmpty()) acceptedIdentities = Collections.singleton(Identity.NULL);
    else acceptedIdentities = new LinkedHashSet<Identity>(identities);
  ...
  public void identities_reject_add(Identity identity, List<Identity> identities) {
    ...
    Set<Identity> rejectedIdentities =
        new LinkedHashSet<Identity>(
            get(accountStateAddress, "identities.reject", Collections.emptyList()));
  ...
  public void identities_reject_set(Identity identity, List<Identity> identities) {
    ...
    Set<Identity> rejectedIdentities;
    if (identities.isEmpty()) rejectedIdentities = Collections.emptySet();
    else rejectedIdentities = new LinkedHashSet<Identity>(identities);
