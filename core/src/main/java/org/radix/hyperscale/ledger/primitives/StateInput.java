...
public final class StateInput extends ExtendedObject implements EphemeralPrimitive {
   ...
   *
   * <p>It can NOT be used to verify the integrity of the state input.
   *
   * <p>TODO At some point implement IDs into primitives which would allow both references by ID and
   * integrity hashes
   */
  @Override
