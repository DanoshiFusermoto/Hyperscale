...
public class Shards implements GlobalInstruction
{
	...
	// Current and Proposed could be UInt256, but using ints is easier for now and allows for 2B validator sets!
	...
	public boolean equals(Object object) 
	{
		...
		{
			if (this.epoch != shards.epoch) 
				return false;
		
			if (this.current != shards.current) 
				return false;

			if (this.proposed != shards.proposed) 
				return false;
