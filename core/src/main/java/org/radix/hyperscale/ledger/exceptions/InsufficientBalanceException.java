...
public class InsufficientBalanceException extends ValidationException {
  ...
  public InsufficientBalanceException(
      final Identity spender, final String symbol, final UInt256 quantity) {
    this(
        "Insufficient balance to spend " + quantity + ":" + symbol + " from " + spender,
        spender,
        symbol,
        quantity);
  }
  ...
  public InsufficientBalanceException(
      final String message, final Identity spender, final String symbol, final UInt256 quantity) {
    super(message);
