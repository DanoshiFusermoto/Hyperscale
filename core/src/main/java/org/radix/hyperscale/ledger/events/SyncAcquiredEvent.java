...
public final class SyncAcquiredEvent extends SyncChangeEvent {
  ...
  public SyncAcquiredEvent(
      final BlockHeader head,
      final StateAccumulator accumulator,
      final Collection<PendingAtom> atoms,
      final Collection<StateVoteCollector> stateVoteCollectors) {
    super();
    ...
    this.atoms =
        Collections.unmodifiableSet(
            new LinkedHashSet<PendingAtom>(Objects.requireNonNull(atoms, "Pending atoms is null")));
    this.stateVoteCollectors =
        Collections.unmodifiableSet(
            new LinkedHashSet<StateVoteCollector>(
                Objects.requireNonNull(stateVoteCollectors, "State vote collectors is null")));
  }
