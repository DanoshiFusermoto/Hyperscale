...
public final class Constants {
  ...
  public static final long BASELINE_DISTANCE_TARGET =
      BigInteger.valueOf(Long.MIN_VALUE)
          ...
          .subtract(
              BigInteger.valueOf(
                      (long)
                          (Long.MIN_VALUE
                              / (BASELINE_DISTANCE_FACTOR * Math.log(BASELINE_DISTANCE_FACTOR))))
                  .abs())
          .longValue(); // TODO rubbish, but produces close enough needed output
  public static final long BLOCK_DISTANCE_FACTOR = 64;
  public static final long BLOCK_DISTANCE_TARGET =
      BigInteger.valueOf(Long.MIN_VALUE)
          .abs()
          .subtract(
              BigInteger.valueOf(
                      (long)
                          (Long.MIN_VALUE
                              / (BLOCK_DISTANCE_FACTOR * Math.log(BLOCK_DISTANCE_FACTOR))))
                  .abs())
          .longValue(); // TODO rubbish, but produces close enough needed output
  ...
  public static final int DEFAULT_CONNECTION_STICKY_DURATION_SECONDS =
      (int) TimeUnit.MINUTES.toSeconds(30);
  public static final int DEFAULT_CONNECTION_ROTATION_INTERVAL_SECONDS =
  ...
  public static final int BLOCKS_PER_PERIOD =
      EPOCH_PERIOD_DURATION_MILLISECONDS / BLOCK_INTERVAL_TARGET_MILLISECONDS;
  public static final int BLOCKS_PER_EPOCH =
      EPOCH_DURATION_MILLISECONDS / BLOCK_INTERVAL_TARGET_MILLISECONDS;
