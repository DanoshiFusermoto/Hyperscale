...
public final class FP12 {
  // Working Variables //
  private static final ThreadLocal<FP2[]> frobFP2_2 =
      ThreadLocal.withInitial(() -> new FP2[] {new FP2(), new FP2()});
  private static final ThreadLocal<FP4[]> inverseFP4_4 =
      ThreadLocal.withInitial(() -> new FP4[] {new FP4(), new FP4(), new FP4(), new FP4()});
  private static final ThreadLocal<FP4[]> mulFP4_4 =
      ThreadLocal.withInitial(() -> new FP4[] {new FP4(), new FP4(), new FP4(), new FP4()});
  private static final ThreadLocal<FP4[]> mulFP4_2 =
      ThreadLocal.withInitial(() -> new FP4[] {new FP4(), new FP4()});
  private static final ThreadLocal<BIG[]> powBIG_2 =
      ThreadLocal.withInitial(() -> new BIG[] {new BIG(), new BIG()});
  private static final ThreadLocal<FP12[]> powFP12_2 =
      ThreadLocal.withInitial(() -> new FP12[] {new FP12(), new FP12()});
  private static final ThreadLocal<FP4[]> sqrFP4_4 =
      ThreadLocal.withInitial(() -> new FP4[] {new FP4(), new FP4(), new FP4(), new FP4()});
  private static final ThreadLocal<FP2[]> smulFP2_9 =
  ...
  private static final ThreadLocal<FP4[]> ssmulFP4_4 =
      ThreadLocal.withInitial(() -> new FP4[] {new FP4(), new FP4(), new FP4(), new FP4()});
  private static final ThreadLocal<FP4[]> ssmulFP4_2 =
      ThreadLocal.withInitial(() -> new FP4[] {new FP4(), new FP4()});
  private static final ThreadLocal<FP4[]> usqrFP4_4 =
      ThreadLocal.withInitial(() -> new FP4[] {new FP4(), new FP4(), new FP4(), new FP4()});
  ...
  public void sqr() {
    ...
    b.add(D);
    c.add(A);
    if (type == SPARSER || type == SPARSEST) type = SPARSE;
    else type = DENSE;
    norm();
  }
  ...
  public void ssmul(FP12 y) {
    ...
    if (y.type >= SPARSE) {
      ...
      if (CONFIG_CURVE.SEXTIC_TWIST == CONFIG_CURVE.D_TYPE) { // dense by sparser - 13m
        ...
        if (y.type == SPARSEST) z2.qmul(y.b.geta().geta());
        ...
        if (y.type == SPARSEST) z3.qmul(y.b.geta().geta());
      ...
      if (CONFIG_CURVE.SEXTIC_TWIST == CONFIG_CURVE.M_TYPE) {
        ...
        if (y.type == SPARSEST) z3.qmul(y.c.getb().geta());
        ...
        if (y.type == SPARSEST) t0.qmul(y.c.getb().geta());
