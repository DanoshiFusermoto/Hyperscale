...
public final class ECP {
  ...
  private static final ThreadLocal<FP[]> addFP_8 =
      ThreadLocal.withInitial(
          () ->
              new FP[] {
                new FP(), new FP(), new FP(), new FP(), new FP(), new FP(), new FP(), new FP()
              });
  private static final ThreadLocal<FP[]> dblFP_5 =
      ThreadLocal.withInitial(() -> new FP[] {new FP(), new FP(), new FP(), new FP(), new FP()});
  ...
  private static final ThreadLocal<BIG[]> clmulBIG_3 =
      ThreadLocal.withInitial(() -> new BIG[] {new BIG(), new BIG(), new BIG()});
  private static final ThreadLocal<ECP[]> clmulECP_3 =
      ThreadLocal.withInitial(() -> new ECP[] {new ECP(), new ECP(), new ECP()});
  private static final ThreadLocal<ECP[]> clmulECP_8 =
      ThreadLocal.withInitial(
          () ->
              new ECP[] {
                new ECP(), new ECP(), new ECP(), new ECP(), new ECP(), new ECP(), new ECP(),
                new ECP()
              });
  private static final ThreadLocal<byte[]> clmulBYTES =
      ThreadLocal.withInitial(() -> new byte[1 + (BIG.NLEN * CONFIG_BIG.BASEBITS + 3) / 4]);
  private static final ThreadLocal<FP[]> m2pFP_16 =
      ThreadLocal.withInitial(
          () ->
              new FP[] {
                new FP(), new FP(), new FP(), new FP(), new FP(), new FP(), new FP(), new FP(),
