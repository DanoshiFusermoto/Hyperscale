...
CBORConstants.MAJOR_TYPE_BYTES, type);
    ...
    private final String _decodeLongerName(int len) throws IOException
    {
        ...
        // For the purpose of our "hack" we simply never intern any long field names to the symbol tables.
        // 99% of the time long field names will be Map keys and not actually field names.
        // It makes no sense to place Map keys into field name tables as it simply just bloats the symbol tables
