...
public class BLSSigCheck {
  public static void main(String[] args) throws Exception {
    ...
    BLSPublicKey pubKey1 =
        BLSPublicKey.from(
            "");
    BLSPublicKey pubKey2 =
        BLSPublicKey.from(
            "");
    ...
    BLSSignature sig1 =
        BLSSignature.from(
            Base58.fromBase58(
                "Ko6mgSEmhnPiqc4XqRETBJ63tLUXGK8y7ok36gVow31CyEwGRaZm6GySAvpi2EpfZW"));
    BLSSignature sig2 =
        BLSSignature.from(
            Base58.fromBase58(
                "VzDoNSFJ7ozaHSbrHMr9KKt1ocQ9f56s1RMc99fY9q83WkUsAsjgmKGkrvPAeFd8vJ"));
    ...
    for (int i = 0; i < ITERATIONS; i++) {
      ...
      if (aggPubCheck.verify(merkleHash, aggSigCheck) == false) System.out.println("FAILED");
    }
