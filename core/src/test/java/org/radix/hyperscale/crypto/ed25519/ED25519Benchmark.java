...
public class ED25519Benchmark {
  ...
  public static void main(String[] args) throws CryptoException {
    ...
    System.out.println("---------");
    System.out.printf(
        "Key Generation: %.2f ms total, %.2f ms per key%n", keyGenTimeMs, keyGenTimeMs / NUM_KEYS);
   ...
   * @throws CryptoException
   */
  private static List<EDSignature> signMessages(List<byte[]> messages, List<EDKeyPair> keyPairs)
      throws CryptoException {
  ...
  private static boolean verifySignatures(
      List<byte[]> messages, List<EDSignature> signatures, List<EDKeyPair> keyPairs)
      throws CryptoException {
